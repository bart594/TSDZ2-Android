...
import spider65.ebike.tsdz2_sw102.databinding.ActivityTorqueSensorSetupBinding;
            ...
            switch (intent.getAction()) {
                case TSDZBTService.TSDZ_CFG_READ_BROADCAST:
                    if (cfg.setData(intent.getByteArrayExtra(TSDZBTService.VALUE_EXTRA))) {
                        binding.setCfg(cfg);
                        String v = String.valueOf(cfg.ui16_torque_sensor_calibration[0][0]);
                        firstNum_1.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[0][1]);
                        secondNum_1.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[1][0]);
                        firstNum_2.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[1][1]);
                        secondNum_2.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[2][0]);
                        firstNum_3.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[2][1]);
                        secondNum_3.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[3][0]);
                        firstNum_4.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[3][1]);
                        secondNum_4.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[4][0]);
                        firstNum_5.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[4][1]);
                        secondNum_5.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[5][0]);
                        firstNum_6.setText(v);
                        v = String.valueOf(cfg.ui16_torque_sensor_calibration[5][1]);
                        secondNum_6.setText(v);
                        initGraph();
                    }
                    break;
