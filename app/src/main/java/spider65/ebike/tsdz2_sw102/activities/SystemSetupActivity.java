...
import spider65.ebike.tsdz2_sw102.databinding.ActivitySystemSetupBinding;
...
public class SystemSetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeekBar seekBarMaxSpeed = findViewById(R.id.seekBarMaxSpeed);
        TextView seekBarValueMaxSpeed = findViewById(R.id.TxtviewSeekBarMaxSpeed);
        ...
        seekBarMaxSpeed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
            ...
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                seekBarValueMaxSpeed.setText(String.valueOf(progress));
            }
        ...
        if (service != null && service.getConnectionStatus() == TSDZBTService.ConnectionState.CONNECTED)
            service.readCfg();
        else showDialog(getString(R.string.error), getString(R.string.connection_error));
    }
    ...
    private void saveCfg() {
        ...
        cfg.ui8_wheel_max_speed =  binding.seekBarMaxSpeed.getProgress();
